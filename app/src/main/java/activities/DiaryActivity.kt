...
class DiaryActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    val category = CategoryNameClass.DIARY
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("ЧЕКЕР", "Открыта DiaryActivity")
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.id_diary -> {
                Toast.makeText(this, "Ты уже на странице дневника", Toast.LENGTH_SHORT).show()
            }
            R.id.id_thoughts -> {
